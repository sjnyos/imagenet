...
COOKIE_DATA='MTYyMDE5NDgwOHxOd3dBTkVjMVRrMVlOMUkyU2taU1REWXlVazVMUnpKUVRFbENVbFJYU0ZKRlExSlNTRkJPU0U1VFRUWkNVVVZRVWtwSlNUVkZOVUU9fDZc69OYBHfrsIc2iD6JVvlHWqf_5OZEXpQY9kZg-t28'
...
def predict(cluster_ip):
    ...
    headers = {'Host': 'imagenet-predictor-default.default.example.com', 'Cookie': 'authservice_session='+ COOKIE_DATA}
...
def explain(cluster_ip):
    ...
    # sending post request to TensorFlow Serving server
    headers = {'Host': 'imagenet-explainer-default.default.example.com', 'Cookie': 'authservice_session='+ COOKIE_DATA}
